        ...
        <section className="max-w-375 mx-auto bg-linear-to-tr from-blue-500 to-indigo-600 md:rounded-2xl lg:rounded-2xl text-white relative overflow-hidden">
          <div className="max-w-375 flex">
            ...
            <div className="relative z-20 w-full lg:w-2/3 p-6">
              <p className="text-sm opacity-80 mb-3 lg:mb-38">Home / Colleges</p>
              <h2 className="text-2xl md:text-3xl mt-3 md:mt-25 font-semibold">Find Your Perfect Colleges</h2>
              <p className="text-md md:text-lg opacity-90 mb-36 md:mb-4">Explore hundreds of colleges to find the right one for you.</p>
              <form onSubmit={handleSearchSubmit} className="w-full mt-4 flex bg-white p-1 md:p-2 rounded-lg shadow-lg border border-gray-200 text-gray-800" >
                ...
                <input type="text" placeholder="Search for colleges..." value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} className="grow p-2 outline-none placeholder-blue-700 bg-transparent" />
              </form>
            </div>

            {/* Hero Image */}
            <div className="absolute lg:relative right-0 bottom-0 lg:w-1/3 flex justify-end pointer-events-none">
              <Image src="/collegehero.png" alt="Hero" width={320} height={320} className="w-72 md:w-78 lg:w-89 z-0 md:z-10" />
            </div>
          </div>
        </section>
      </div>
                    ...
                    <div className="flex flex-col sm:flex-row justify-end items-start sm:items-center gap-4">
                      ...
                      <div className="flex gap-2 w-full sm:w-auto ">
                        <button className="flex-1 sm:flex-none border-2 border-[#2D5BFF] text-[#2D5BFF] font-bold px-4 md:px-6 py-2 rounded-lg hover:bg-blue-50 transition-colors text-xs md:text-sm">
                          ...
                          <a href={`/colleges/${college.slug}`} className="flex-1 sm:flex-none bg-[#155DFC] text-white font-bold px-4 md:px-6 py-2 rounded-lg shadow-md hover:bg-[#4338CA] transition-colors text-center justify-center text-xs md:text-sm">View More</a>
                      </div>
                    </div>
                  </div>
                </div>
