  ...
  return (
    <div className="mx-auto max-w-375 min-[575]:px-6">
      ...
      >
        ...
        {/* LEFT CONTENT */}
        <div className="flex items-center h-full z-20 min-[424]:w-[90%] max-[424]:w-full min-[575]:w-[65%] lg:w-[70%] sm:w-[60%] md:w-[65%] sm:ml-3">
          <div className=''>

            <h2 className="fred-banner-title text-[27px] lg:text-[32px] md:text-[22px] min-[575]:text-[22px] max-w-275 p-0 font-semibold text-[#1a1a1a] tracking-wide md:tracking-wider opacity-0 transition-all duration-500">
              Tamil Nadu&apos;s Most Trusted Unified College Application Platform
            </h2>

            <div className="max-w-275 max-[575]:-mt-4 lg:flex lg:gap-4 items-center p-0 m-0">
              <p className="fred-banner-desc text-[15px] md:text-[14px] font-medium text-[#3a3a2a] mb-5 lg:mb-0 items-center italic tracking-wider md:tracking-widest opacity-0 transition-all duration-500 delay-200">
                Apply to multiple TN colleges with just one simple form.
              </p>
              <a
                href="#"
                className="fred-banner-btn px-8 py-3 bg-[#FFE8A5] hover:bg-[#ffd970] text-[#1a1a1a] mb-3 lg:mb-0 font-semibold text-[14px] rounded-[10px] tracking-wide md:tracking-wider whitespace-nowrap transition-colors opacity-0 duration-700 delay-350"
              >
